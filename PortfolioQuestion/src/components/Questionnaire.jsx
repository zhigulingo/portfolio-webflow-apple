...
export default function Questionnaire() {
  ...
  const handleBack = () => {
    ...
    if (showRecommendation) {
      setShowRecommendation(false);
      // Go back to the last actual question (question 6)
      setCurrentStep(questions.findIndex(q => q.id === 6));
      return;
    }
  ...
  const handleNext = () => {
    ...
    setTimeout(() => {
      if (currentStep < questions.length - 1) {
        ...
        // After the last question (budget), show recommendation
        const structuredAnswers = {
          productType: answers[1],
          businessGoal: answers[2],
          industry: answers[3],
          deadline: answers[4],
          materials: answers[5],
          budget: answers[6]
        ...
        const rec = getRecommendations(structuredAnswers);
  ...
  const handleSubmit = (e) => {
    ...
    // Include the suggested package in the submission
    const submissionData = {
      answers,
      contactInfo,
      suggestedPackage: JSON.stringify(recommendation)
    };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      >
        ...
        <div className="px-8 py-6 border-b border-gray-100">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              {(currentStep > 0 || showContactForm || showRecommendation) && !isCompleted && (
          ...
          {!showContactForm && !showRecommendation && !isCompleted && (
        ...
        {!isCompleted && !showRecommendation && (
